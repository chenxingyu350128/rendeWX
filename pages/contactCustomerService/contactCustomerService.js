// pages/contactCustomerService/contactCustomerService.js
// pages/chat/chat.js

const app = getApp()

// var websocket = require('../../utils/websoket.js');
...
Page({
  ...
  */
  ...
  data: {
    ...
    scrollTop: 0,
    my_message:[],
    first_text:"你好！May I help you?1111111111111111111111111111111111",
    my_text: "",
    message: "",
  },
  call:function(){
  ...
  */
  ...
  send: function () {
    ...
    var flag = this
    var my_message = this.data.my_message
    // flag.data.message.trim() == ""
    if (flag.data.message.trim() == "") {
      ...
      // console.log(flag.data.my_text)
    } else {
      flag.setData({
        my_text: flag.data.message,
      })
      flag.setData({
        // my_text: flag.data.message,
        my_message: my_message.concat(this.data.my_text),
        message: ""
      })
      this.bottom();
      // setTimeout(function () {
